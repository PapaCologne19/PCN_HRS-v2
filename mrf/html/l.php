                        ...
                        <div class="containers">
                            <div class="card">
                                ...
                                <table class="table" id="example" style="font-size: 13px !important;">
                                    ...
                                    <tbody>
                                        <?php
                                        $queries = "SELECT shortlist.*, employee.*, shortlist.project_status AS for_loa_status, employee.id AS employee_id
                                                        ...
                                                        <td>
                                                            <?php if ($rows['deployment_status'] === 'DEPLOYED' && $rows['for_loa_status'] === "FOR LOA") { ?>
                                                                <div class="contain">
                                                                    <div class="columns">
                                                                        <?php
                                                                        if ($deployment_row['clearance'] === "ACTIVE" && $deployment_row['signed_loa_status'] === "UNRETURN" || $deployment_row['signed_loa_status'] === "SUBMITTED") {
                                                                        ?>
